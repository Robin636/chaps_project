...
class Pair(models.Model):
  chap = models.ForeignKey('chaps.Chap', on_delete=models.CASCADE, related_name='pairs')
...
class IPair(models.Model):
  chap = models.ForeignKey('chaps.IChap', on_delete=models.CASCADE, related_name='Ipairs')
  textL = models.CharField(max_length=200)
  textR = models.CharField(max_length=200)
  status = models.IntegerField(default=0, blank=True)
